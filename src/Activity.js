        ...
        <div className="w-100 center">
          <section className="bg-gradient-blue-title">
            <div className="flex justify-center items-center pt5">
              <span className="absolute right-2 top-2 light-blue f4 pointer grow arial" 
                onClick={e => {
                  this.onClose(e);
                }}
              >X
              ...
              <div className="pa3 tl nb4 mt2">
                <h1 className="ma0 f3 light-blue">{this.props.data.title}</h1>
                <span>
          ...
          <section className="bg-gradient-blue-content pt5">
            <div className="mw8 w-100 center">
              <h2 className="f3 pb5">Activity updates</h2>
